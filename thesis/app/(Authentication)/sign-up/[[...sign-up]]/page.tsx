            ...
            {(isGlobalLoading) => (
              <>
                ...
                <SignUp.Step name="continue">
                  <Card className="w-full sm:w-96 flex flex-col items-center justify-center mx-auto bg-slate-100">
                    <CardHeader>
                ...
                <SignUp.Step name="verifications">
                  <SignUp.Strategy name="email_code">
                    <Card className="w-full sm:w-96 flex-col items-center justify-center mx-auto">
                      <CardHeader>
